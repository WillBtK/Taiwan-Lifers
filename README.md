...
| 10 | **US holdings by security type** | Taiwan's holdings of US long-term securities from the TIC benchmark survey, split Treasuries / agency debt / agency ABS / corporate bonds / corporate ABS / equities, with the all-foreign-holder denominators stored alongside so a market share is computed rather than asserted. Treasuries and agency non-ABS mix the CBC's reserves with private portfolios and are **not** attributed to the lifers; agency ABS and corporate debt are. Peak share of all foreign-held US agency MBS **26.2% (2018)**, now 14.0%; corporate bonds 1.5% → **4.1%**. Taiwan absorbed **33% of the increase in foreign agency-MBS holdings 2013-19** and **17% of the increase in foreign corporate-bond holdings 2019-24**. **Levels are at market value: a change in level is not a purchase** — read 4.42, which corrects 4.40's reading of the agency-MBS decline as liquidation; the BoP says the sector was still buying (decisions 4.40, 4.42) | country | A | **2013** (composition), 2007 (total LT debt) |
